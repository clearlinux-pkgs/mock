...
Version  : 3.0.1
Release  : 78
URL      : https://github.com/rpm-software-management/mock/archive/mock-3.0-1/mock-3.0.1.tar.gz
Source0  : https://github.com/rpm-software-management/mock/archive/mock-3.0-1/mock-3.0.1.tar.gz
...
%prep
%setup -q -n mock-mock-3.0-1
cd %{_builddir}/mock-mock-3.0-1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652648501
...
cp %{_builddir}/mock-mock-3.0-1/LICENSE %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/mock-mock-3.0-1/docs/LICENSE %{buildroot}/usr/share/package-licenses/mock/34b2b37ec594d86bd391137b4fb644eccb17bdbb
cp %{_builddir}/mock-mock-3.0-1/mock-core-configs/COPYING %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/mock-mock-3.0-1/mock/COPYING %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
%make_install
