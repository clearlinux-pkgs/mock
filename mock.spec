...
Version  : 2.4.1
Release  : 68
URL      : https://github.com/rpm-software-management/mock/archive/mock-2.4-1.tar.gz
Source0  : https://github.com/rpm-software-management/mock/archive/mock-2.4-1.tar.gz
...
Patch9: 0009-Do-not-disable-unavailable-plugin.patch
Patch10: 0010-Add-site-defaults.cfg.patch
Patch11: 0011-Fix-clear.cfg.patch
Patch12: 0012-Add-Clear-Linux-cert_path.patch
...
%prep
%setup -q -n mock-mock-2.4-1
cd %{_builddir}/mock-mock-2.4-1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632272501
...
cp %{_builddir}/mock-mock-2.4-1/LICENSE %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/mock-mock-2.4-1/mock-core-configs/COPYING %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/mock-mock-2.4-1/mock/COPYING %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
%make_install
