...
Patch5: 0005-Allow-the-groupadd-command-to-fail.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698087135
...
cp %{_builddir}/mock-5.2/COPYING %{buildroot}/usr/share/package-licenses/mock/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1 || :
%make_install
